...
Monitors the 10 most recently active followed wallets for trades made within the last **2 hours**. When **2 or more wallets** appear in the same market, an intersection is recorded.
